...
def get_exact_potential(poscarfile, frac_sites):
    ...
    subprocess.run(["/fs2/home/jiangh/members/ZhangT/AIMPModelGenerator-main/calcmad", infile, outfile])
...
#potentials = get_exact_potential("Cs3Cu2Cl5.vasp", [[0.5, 0.5, 0.5], [0.45, 0.45, 0.45]])
#print(potentials)
